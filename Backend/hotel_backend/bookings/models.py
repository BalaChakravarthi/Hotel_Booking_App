...
#     rating = models.IntegerField(null=True, blank=True)  # ⭐ NEW
...
#     if created:
#         return  # Don't send on booking creation
...
#         <ul>
#             <li><strong>Room:</strong> {instance.room.room_type}</li>
...
class Booking(models.Model):
    ...
    STATUS_CHOICES = (
        ...
        ('approved', 'Approved'),
        ('rejected', 'Rejected'),
        ('paid', 'Paid'),   # ✅ Added missing paid status
    )
